...
$cc.validate = function(e){
  ...
  if (e.target.value == ''){
    document.getElementById('iscard-type').className = 'card-type';
    document.getElementById('cc_number').className = 'CC_field';
    return
  }
  ...
  if (isLuhn == true){
     document.getElementById('cc_number').className = 'CC_field card-valid'
  }else{
     document.getElementById('cc_number').className = 'CC_field'
  }
  ...
  for (var i = 0; i< card_types.length; i++){
    if (number.match(card_types[i].pattern)){
      ...
      document.getElementById('iscard-type').className = 'card-type '+card_types[i].name;
    }
  }
}
